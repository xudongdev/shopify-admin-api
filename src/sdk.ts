...
/** A line item with changes applied to them. */
...
export type Mutation = {
   ...
   */
  productBulkAddPriceReductions?: Maybe<ProductBulkAddPriceReductionsPayload>;
  /**
   * Removes the price reduction of products in bulk.
   * @deprecated Removed in 2020-04.
   */
  productBulkRemovePriceReductions?: Maybe<ProductBulkRemovePriceReductionsPayload>;
  /** Creates a product. */
...
/** The schema's entry point for all mutation operations. */
export type MutationProductBulkAddPriceReductionsArgs = {
  productIds?: Maybe<Array<Scalars['ID']>>;
  savedSearchId?: Maybe<Scalars['ID']>;
  search?: Maybe<Scalars['String']>;
  priceReduction: PriceReductionInput;
};


/** The schema's entry point for all mutation operations. */
export type MutationProductBulkRemovePriceReductionsArgs = {
  productIds?: Maybe<Array<Scalars['ID']>>;
  savedSearchId?: Maybe<Scalars['ID']>;
  search?: Maybe<Scalars['String']>;
};
...
export type ProductBulkAddPriceReductionsPayload = {
...
export type ProductBulkRemovePriceReductionsPayload = {
...
export type GetDraftOrderQuery = (
  { __typename?: 'QueryRoot' }
  & { draftOrder?: Maybe<(
    { __typename?: 'DraftOrder' }
    & DraftOrderFragment
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getDraftOrder(variables: GetDraftOrderQueryVariables): Promise<GetDraftOrderQuery> {
      return withWrapper(() => client.request<GetDraftOrderQuery>(print(GetDraftOrderDocument), variables));
    }
  };
}
